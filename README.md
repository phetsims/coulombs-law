...
(5) Open in the browser: `http://localhost/coulombs-law/coulombs-law_en.html` (You will probably need to modify this URL based on your HTTP port and relative path.)
...
(3) Open in the browser: `http://localhost/coulombs-law/build/adapted-from-phet/coulombs-law_en_adapted-from-phet.html` (You will probably need to modify this URL based on your HTTP port and relative path.)
