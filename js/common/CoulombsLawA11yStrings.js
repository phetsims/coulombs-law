...
const CoulombsLawA11yStrings = {
  ...
  smallStepsMoveChargesDescription: {
    value: 'Move in smaller steps with the shift key plus the left and right arrows.'
  },
...
if ( phet.chipper.queryParameters.stringTest === 'xss' ) {
  for ( const key in CoulombsLawA11yStrings ) {
...
coulombsLaw.register( 'CoulombsLawA11yStrings', CoulombsLawA11yStrings );
export default CoulombsLawA11yStrings;